...
This is just a quick and dirty copy and edit of gobo2html2.xsl.
I just changed the background and deleted the navigation images
since they don't play well with the existing Goanna documentation.
Probably best to start over with gobo2html2.xsl if one is going
to do it right.
	...
	<tr>
		<td>
			<address><font size="2">
				...
				<br/>
				<b>http://</b><a href="http://goanna.sourceforge.net">goanna.sourceforge.net</a>
				<br/>
