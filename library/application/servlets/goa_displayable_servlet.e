...
feature -- Attributes
	...
	standard_submit_label (processing_result: REQUEST_PROCESSING_RESULT): STRING is
...
feature -- Page Building
	...
	add_body (processing_result: REQUEST_PROCESSING_RESULT; xml: GOA_XML_DOCUMENT) is
			-- Add the body to xml
		require
			not_ok_to_read_write_data: implements_transaction_and_version_access implies not (ok_to_read_data (processing_result) or ok_to_write_data (processing_result))
			valid_processing_result: processing_result /= Void
	...
	add_footer (processing_result: REQUEST_PROCESSING_RESULT; xml: GOA_XML_DOCUMENT) is
...
feature
	...
	send_response (processing_result: REQUEST_PROCESSING_RESULT) is
