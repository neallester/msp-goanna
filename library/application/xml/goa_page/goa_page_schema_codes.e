...
indexing
	...
	description: "Codes and constants representing elements/attributes of the xmlns:goa_page schema"
	author: ""
...
feature -- Element Tags
	...
	page_element_tag: STRING is "goa_page:page"
...
feature -- Attribute Names
	...
	host_name_attribute_name: STRING is "host_name"
	submit_url_attribute_name: STRING is "submit_url"
...
feature -- Codes
	...
	host_name_attribute_code, submit_url_attribute_code, dummy_attribute_code, class_attribute_code,
	paragraph_element_code, text_item_element_code, division_element_code, ordered_list_element_code,
	...
	page_element_code, xml_text_code, xml_null_code: INTEGER is Unique	
...
feature {NONE} -- Implementation
	...
	element_code_by_tag: DS_HASH_TABLE [INTEGER, STRING] is
		...
		once
			...
			Result.force (page_element_code, page_element_tag)
		end
	...
	element_tag_by_code: DS_HASH_TABLE [STRING, INTEGER] is
		...
		once
			...
			Result.force (page_element_tag, page_element_code)
		end
	...
	attribute_code_by_name: DS_HASH_TABLE [INTEGER, STRING] is
		...
		once
			...
			Result.force (host_name_attribute_code, host_name_attribute_name)
			Result.force (submit_url_attribute_code, submit_url_attribute_name)
	...
	attribute_name_by_code: DS_HASH_TABLE [STRING, INTEGER] is
		...
		once
			...
			Result.force (host_name_attribute_name, host_name_attribute_code)
			Result.force (submit_url_attribute_name, submit_url_attribute_code)
			Result.force (dummy_attribute_name, dummy_attribute_code)
			Result.force (class_attribute_name, class_attribute_code)
		end

end -- GOA_PAGE_SCHEMA_CODES
