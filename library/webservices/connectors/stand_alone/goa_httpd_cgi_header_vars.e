indexing
	description: "HTTP header variable constants"
...
class GOA_HTTPD_CGI_HEADER_VARS
...
feature -- Access
	...
	Content_type_var: STRING is "HTTP_CONTENT_TYPE"
	Content_length_var: STRING is "HTTP_CONTENT_LENGTH"
...
end -- class GOA_HTTPD_CGI_HEADER_VARS
