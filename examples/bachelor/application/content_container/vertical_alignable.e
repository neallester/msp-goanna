...
feature {NONE} -- Implementation
	...
	vertical_top, vertical_middle, vertical_bottom, vertical_baseline : INTEGER is UNIQUE
		-- identifiers for alignment codes

	vertical_alignment_code_labels : ARRAY [STRING] is
