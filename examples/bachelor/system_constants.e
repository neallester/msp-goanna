...
feature -- File names
	...
	file_extension : STRING = ".sto"
		-- The extension added to data files

	unique_query_string_factory_file_name : STRING
	...
	unique_request_string_factory_file_name : STRING
	...
	unique_form_element_name_factory_file_name : STRING
	...
	unique_to_do_anchor_factory_file_name : STRING
	...
	unique_goanna_session_identifier_factory_file_name : STRING
	...
	valid_organizational_name_list_file_name : STRING
...
feature {NONE} -- Validity Checking
	...
	data_directory_tester: DIRECTORY
